...
public class ExcelExportService : IExcelExportService
{
    ...
    /// </remarks>
    private static void CreateKeyMetricsSheet(XLWorkbook workbook, List<GroceryItemDto> groceries)
    {
    ...
    /// </remarks>
    private static void CreateProfitByCategorySheet(XLWorkbook workbook, List<GroceryItemDto> groceries)
    {
    ...
    /// </remarks>
    private static void CreateTopProfitableItemsSheet(XLWorkbook workbook, List<GroceryItemDto> groceries)
    {
    ...
    /// </remarks>
    private static void CreateStockAnalysisSheet(XLWorkbook workbook, List<GroceryItemDto> groceries)
    {
    ...
    /// </remarks>
    private static void CreatePriceRangeAnalysisSheet(XLWorkbook workbook, List<GroceryItemDto> groceries)
    {
